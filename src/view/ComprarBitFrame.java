...
//    public ComprarBitFrame(LoginFrame lf) {
//        initComponents();
//        controller = new ControllerComprarBit(this);
...
//            if(res.next()){
//                
//                double SaldoBit = res.getDouble("bitcoin");
//                
//                this.getLblSaldoBitcoin().setText(String.valueOf(SaldoBit));
//                
//                
//            } else {
